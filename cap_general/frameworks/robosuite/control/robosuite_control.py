"""Robosuite code-execution control."""
...
@dataclass
class RobosuiteControlConfig(BaseControlConfig):
    """Configuration for RobosuiteControl."""
...
class RobosuiteControl(BaseControl):
    """Control that executes Franka pick-place code against a Robosuite robot."""

    control_type = "robosuite"
    config_cls = RobosuiteControlConfig

    def __init__(self, config: RobosuiteControlConfig, logger: Logger):
