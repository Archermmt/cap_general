"""Genesis GO2 locomotion control."""
...
@dataclass
class GenesisGo2ControlConfig(GenesisBaseControlConfig):
    """Configuration for GenesisGo2Control."""
...
class GenesisGo2Control(GenesisBaseControl):
    """Control that evaluates Genesis GO2 locomotion policies."""

    control_type = "genesis_go2"
    config_cls = GenesisGo2ControlConfig
