"""Genesis grasp manipulation control."""
...
@dataclass
class GenesisGraspControlConfig(GenesisBaseControlConfig):
    """Configuration for GenesisGraspControl."""
...
@GenesisBaseControl.register()
class GenesisGraspControl(GenesisBaseControl):
    """Control that evaluates Genesis Franka grasp policies."""

    control_type = "genesis_grasp"
    config_cls = GenesisGraspControlConfig
    ...
    def grasp_episode(self, stage: str | None = None, max_steps: int | None = None) -> dict[str, Any]:
        ...
        Args:
            stage: ``'rl'`` for the RL runner policy, ``'bc'`` for the behavior-cloning policy.
                Defaults to the control's configured stage.
            max_steps: Maximum simulation steps (default: control max_steps).
        """
