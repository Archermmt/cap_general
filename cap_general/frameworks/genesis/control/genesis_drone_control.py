...
@dataclass
class GenesisDroneControlConfig(GenesisBaseControlConfig):
    """Configuration for GenesisDroneControl."""
...
class GenesisDroneControl(GenesisBaseControl):
    """Control that evaluates Genesis drone hover policies."""

    control_type = "genesis_drone"
    config_cls = GenesisDroneControlConfig
