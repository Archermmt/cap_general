...
Local train mode:
    python tests/genesis/test_genesis_grasp.py --train_ep 100

Remote task mode:
    capcmd server --config configs/genesis/genesis_grasp.yaml
    python tests/genesis/test_genesis_grasp.py --remote --config configs/genesis/genesis_grasp.yaml

Remote train mode:
    capcmd server --config configs/genesis/genesis_grasp.yaml
    python tests/genesis/test_genesis_grasp.py --remote --config configs/genesis/genesis_grasp.yaml --train_ep 100
"""
...
_DEFAULT_TASK_NUM = 4
_DEFAULT_CONFIG = "configs/genesis/genesis_grasp.yaml"
