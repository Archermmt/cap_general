...
Remote mode:
    capcmd server --config configs/genesis/genesis_drone.yaml
    python tests/genesis/test_genesis_drone.py --remote --config configs/genesis/genesis_drone.yaml
"""
...
_DEFAULT_CONFIG = "configs/genesis/genesis_drone.yaml"
_DEFAULT_TASK_NUM = 5
