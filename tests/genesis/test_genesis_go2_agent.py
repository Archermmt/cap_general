...
Remote mode:
    ...
    python tests/genesis/test_genesis_go2_agent.py --remote --config configs/genesis/genesis_go2_agent.yaml
"""
...
_DEFAULT_CONFIG = "configs/genesis/genesis_go2_agent.yaml"
_DEFAULT_TASK_NUM = 5
_DEFAULT_AGENT = "go2"
ROUND_NUM = 10
